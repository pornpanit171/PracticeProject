...
(function () {
  const STRINGS = {
    ...
    examHint: { en: 'No hints · timed per question', th: 'ไม่มีคำใบ้ · จับเวลาทีละข้อ' },
    modeNote: {
      en: 'Practice mode also has a per-question timer and a Finish Now button, but shows the correct answer and explanation immediately after each question.',
      th: 'โหมดฝึกทำมีการจับเวลาต่อข้อและปุ่มจบทันทีเช่นกัน แต่จะเฉลยคำตอบพร้อมคำอธิบายให้ทันทีหลังตอบแต่ละข้อ'
    },
    ...
    reveal: { en: 'ANSWER REVEAL', th: 'การเฉลย' },
    revealInstant: { en: 'After each question', th: 'เฉลยทันทีทุกข้อ' },
    revealInstantHint: { en: 'See the answer straight away', th: 'เห็นคำตอบทันทีที่ตอบเสร็จ' },
    revealEnd: { en: 'At the end', th: 'เฉลยตอนจบ' },
    revealEndHint: { en: 'All answers shown after finishing', th: 'ดูเฉลยทั้งหมดหลังทำเสร็จ' },
    revealLockedByExam: { en: 'Exam mode always reveals answers at the end.', th: 'โหมดจำลองสอบจะเฉลยตอนจบเสมอ' },
